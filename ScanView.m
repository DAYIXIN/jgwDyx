...
- (void)setupCaptureSession {
    ...
    //    [ _output setRectOfInterest : CGRectMake (( 124 )/ self.frame.size.height ,(( self.frame.size.width - 220 )/ 2 )/ self.frame.size.width , 220 / self.frame.size.height , 220 / self.frame.size.width )];
...
- (void)startRunning {
    ...
    _output.metadataObjectTypes = @[AVMetadataObjectTypeQRCode,AVMetadataObjectTypeCode39Code,
    ...
    [metadataObjects
                                  ...
                                  BOOL *stop)
     {
              ...
              [AVMetadataMachineReadableCodeObject class]])
         {
             ...
             if (self.delegate) {
                 _codeing = NO;
                 [self.delegate IOSScanResult:stringValue];
             }
         }
     }];
}
